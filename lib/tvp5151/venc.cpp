...
esp_h264_err_t H264::init_hw_H264_enc_single(esp_h264_enc_cfg_hw_t config) {
    cfg = config;
...
esp_h264_err_t H264::run_hw_H264_enc_single() {
    esp_h264_err_t ret = ESP_H264_ERR_OK;
...
esp_h264_err_t H264::close_hw_H264_enc_single() {
    esp_h264_err_t ret = ESP_H264_ERR_OK;
