...
esp_h264_enc_cfg_t H264::set_H264_config_single(esp_h264_raw_format_t format, uint8_t fps, uint16_t height, uint16_t width, uint32_t bitrate, uint8_t qp_min, uint8_t qp_max, uint8_t gop) {
...
esp_h264_enc_in_frame_t* H264::get_inframe() {
    return &in_frame;
}

esp_h264_enc_out_frame_t* H264::get_ouyframe() {
    return &out_frame;
}

//adapted from esp_h264_hw_enc_test.c:19, change calloc function calls
esp_h264_err_t H264::init_H264_enc_single(esp_h264_enc_cfg_t config, enc_type type) {
    cfg = config;
...
esp_h264_err_t H264::run_H264_enc_single() {
    esp_h264_err_t ret = ESP_H264_ERR_OK;
...
esp_h264_err_t H264::close_H264_enc_single() {
    esp_h264_err_t ret = ESP_H264_ERR_OK;
